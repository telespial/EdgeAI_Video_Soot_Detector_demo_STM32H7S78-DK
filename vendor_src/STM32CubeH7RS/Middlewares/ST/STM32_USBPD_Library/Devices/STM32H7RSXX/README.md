...
This repository provides the STM32Cube **device-specific** Middleware Library of the **STM32CubeH7RS** MCU firmware for managing the **USB Type-C** physical layer.
