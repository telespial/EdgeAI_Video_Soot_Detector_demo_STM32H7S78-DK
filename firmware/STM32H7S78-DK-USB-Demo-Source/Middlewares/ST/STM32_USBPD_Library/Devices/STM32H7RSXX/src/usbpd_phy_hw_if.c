...
#define UCPD_VALUE_TRIM_CC2_RP_3A0_POS  (20U)
#define UCPD_VALUE_TRIM_CC2_RP_3A0_MSK  (0xFUL << UCPD_VALUE_TRIM_CC2_RP_3A0_POS) /*!< 0x00F00000 */
#define UCPD_VALUE_TRIM_CC2_RP_3A0      UCPD_VALUE_TRIM_CC2_RP_3A0_MSK            /*!< SW trim value for RP 3A0 (CC2) */
#define UCPD_VALUE_TRIM_CC2_RP_1A5_POS  (4U)
#define UCPD_VALUE_TRIM_CC2_RP_1A5_MSK  (0xFUL << UCPD_VALUE_TRIM_CC2_RP_1A5_POS) /*!< 0x000000F0 */
#define UCPD_VALUE_TRIM_CC2_RP_1A5      UCPD_VALUE_TRIM_CC2_RP_1A5_MSK            /*!< SW trim value for RP 1A5 (CC2) */
#define UCPD_VALUE_TRIM_CC2_RD_POS      (16U)
#define UCPD_VALUE_TRIM_CC2_RD_MSK      (0xFUL << UCPD_VALUE_TRIM_CC2_RD_POS)     /*!< 0x000F0000 */
...
const __IO uint32_t *pUCPD_TRIM_3A0_CC1 = (uint32_t *)(0x52002834UL);
const __IO uint32_t *pUCPD_TRIM_3A0_CC2 = (uint32_t *)(0x52002834UL);
const __IO uint32_t *pUCPD_TRIM_1A5_CC1 = (uint32_t *)(0x52002830UL);
const __IO uint32_t *pUCPD_TRIM_1A5_CC2 = (uint32_t *)(0x52002830UL);
const __IO uint32_t *pUCPD_TRIM_Rd_CC1  = (uint32_t *)(0x52002834UL);
...
void USBPD_HW_IF_GlobalHwInit(void)
{
  ...
  if (((dev_id == 0x485UL) && (rev_id == 0x1000UL)) ||
      ((dev_id == 0x485UL) && (rev_id == 0x1001UL)))
  {
...
{
  /* Not needed on STM32H7RSxx, so nothing to do, keep only for compatibility */
  UNUSED(PortNum);
}
