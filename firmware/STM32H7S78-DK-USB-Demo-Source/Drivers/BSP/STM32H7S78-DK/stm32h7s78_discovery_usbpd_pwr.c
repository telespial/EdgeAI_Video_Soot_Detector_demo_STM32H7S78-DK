/**
  ******************************************************************************
  * @file    stm32h7s78_discovery_usbpd_pwr.c
...
/** @defgroup STM32H7S78_DK_USBPD_PWR_Exported_Variables Exported Variables
  * @{
  */
/**
  * @}
...
/** @defgroup STM32H7S78_DK_USBPD_PWR_Private_Typedef Private Typedef
  * @{
  */
/**
...
/** @defgroup STM32H7S78_DK_USBPD_PWR_Private_Constants Private Constants
  * @{
  */
...
/** @defgroup STM32H7S78_DK_USBPD_PWR_Private_Macros Private Macros
  * @{
  */
#ifdef _TRACE
...
/** @defgroup STM32H7S78_DK_USBPD_PWR_Private_Functions Private Functions
  * @{
  */
...
/** @defgroup STM32H7S78_DK_USBPD_PWR_Private_Variables Private Variables
  * @{
  */
...
/** @addtogroup STM32H7S78_DK_USBPD_PWR_Exported_Functions
  * @{
  */
...
/** @addtogroup STM32H7S78_DK_USBPD_PWR_Private_Functions
  * @{
  */
      ...
      switch (USBPD_PWR_Port_Status[PortNum].PwrSavingMode)
      {
        ...
        case USBPD_PWR_MODE_NORMAL:
        {
          ...
          if ((flg_reg & TCPP0203_FLAG_OCP_VBUS_SET) == TCPP0203_FLAG_OCP_VBUS_SET)
          {
            ...
            if ((USBPD_PWR_Port_Status[PortNum].LastFaultTick == 0U)
                || ((tickfault > USBPD_PWR_Port_Status[PortNum].LastFaultTick)
