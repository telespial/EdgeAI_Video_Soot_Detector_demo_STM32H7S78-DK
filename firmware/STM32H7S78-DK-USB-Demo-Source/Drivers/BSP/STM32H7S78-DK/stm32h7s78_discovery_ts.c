/**
  ******************************************************************************
  * @file    stm32h7s78_discovery_ts.c
  * @author  MCD Application Team
  * @brief   This file provides a set of firmware functions to communicate
  *          with  external devices available on STM32H7S78-DK board (MB1736) from
  *          STMicroelectronics
  ******************************************************************************
  * @attention
  *
...
--------------------------
   - This driver is used to drive the GT911 touch screen module
     mounted over TFT-LCD on the STM32H7S78_DK board.
...
/** @defgroup STM32H7S78_DK_TS TS
  * @{
  */

/** @defgroup STM32H7S78_DK_TS_Private_Types_Definitions Private Types Definitions
  * @{
  */
/**
  * @}
...
/** @defgroup STM32H7S78_DK_TS_Private_Defines Private Types Defines
  * @{
  */
/**
  * @}
...
/** @defgroup STM32H7S78_DK_TS_Private_Macros Private Macros
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32H7S78_DK_TS_Private_Function_Prototypes Private Function Prototypes
  * @{
  */
...
/** @defgroup STM32H7S78_DK_TS_Privates_Variables Privates Variables
  * @{
  */
...
/** @defgroup STM32H7S78_DK_TS_Exported_Variables Exported Variables
  * @{
  */
...
/** @defgroup STM32H7S78_DK_TS_Exported_Functions Exported Functions
  * @{
  */
...
int32_t BSP_TS_Init(uint32_t Instance, TS_Init_t *TS_Init)
{
  ...
  else
  {
    ...
    {
      TS_Capabilities_t Capabilities = {0};
      uint32_t i;
...
int32_t BSP_TS_Get_MultiTouchState(uint32_t Instance, TS_MultiTouch_State_t *TS_State)
{
  ...
  {
    GT911_MultiTouch_State_t state = {0};
...
/**
  * @}
  */
/** @defgroup STM32H7S78_DK_TS_Private_Functions Private Functions
  * @{
  */
