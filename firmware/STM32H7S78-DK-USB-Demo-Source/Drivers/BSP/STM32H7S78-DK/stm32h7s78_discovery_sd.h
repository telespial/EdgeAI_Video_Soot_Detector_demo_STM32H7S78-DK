/**
  ******************************************************************************
  * @file    stm32h7s78_discovery_sd.h
  * @author  MCD Application Team
  * @brief   This file contains the common defines and functions prototypes for
  *          the stm32h7s78_discovery_sd.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef STM32H7S78_DK_SD_H
#define STM32H7S78_DK_SD_H
...
/** @defgroup STM32H7S78_DK_SD_Exported_Types SD Exported Types
  * @{
  */
...
/** @defgroup STM32H7S78_DK_SD_Exported_Constants SD Exported Constants
  * @{
  */
...
#define SD_DETECT_GPIO_CLK_ENABLE()          __HAL_RCC_GPIOM_CLK_ENABLE()
#define SD_DETECT_GPIO_CLK_DISABLE()         __HAL_RCC_GPIOM_CLK_DISABLE()
...
/** @addtogroup STM32H7S78_DK_SD_Exported_Variables
  * @{
  */
...
/** @addtogroup STM32H7S78_DK_SD_Exported_Functions
  * @{
  */
