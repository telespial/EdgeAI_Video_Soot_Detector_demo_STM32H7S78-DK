/**
  ******************************************************************************
  * @file    stm32h7s78_discovery_ts.h
...
#ifndef STM32H7S78_DK_TS_H
#define STM32H7S78_DK_TS_H
...
/** @addtogroup STM32H7S78_DK_TS
  * @{
  */

/** @defgroup STM32H7S78_DK_TS_Exported_Constants Exported Constants
  * @{
  */
...
#define TS_INT_EXTI_IRQn             EXTI3_IRQn
#define TS_EXTI_LINE                 EXTI_LINE_3

/**
  * @}
  */

/** @defgroup STM32H7S78_DK_TS_Exported_Types Exported Types
  * @{
  */
typedef struct
{
...
/** @addtogroup STM32H7S78_DK_TS_Exported_Variables
  * @{
  */
...
/** @defgroup STM32H7S78_DK_TS_Exported_FunctionsPrototypes Exported Functions Prototypes
  * @{
  */
