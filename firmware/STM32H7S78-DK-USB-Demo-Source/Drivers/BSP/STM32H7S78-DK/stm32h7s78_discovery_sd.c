/**
  ******************************************************************************
  * @file    stm32h7s78_discovery_sd.c
  * @author  MCD Application Team
  * @brief   This file includes the uSD card driver mounted on STM32H7S78_DK
  *          boards.
  ******************************************************************************
  * @attention
  *
...
/** @defgroup STM32H7S78_DK_SD SD
  * @{
  */

/** @defgroup STM32H7S78_DK_SD_Private_TypesDefinitions SD Private TypesDefinitions
  * @{
  */
...
typedef void (*BSP_EXTI_SD_LineCallback)(void);
/**
  * @}
  */

/** @defgroup STM32H7S78_DK_SD_Exported_Variables SD Exported Variables
  * @{
  */
...
/** @defgroup STM32H7S78_DK_SD_Private_Variables SD Private Variables
  * @{
  */
...
/** @defgroup STM32H7S78_DK_SD_Private_Functions_Prototypes SD Private Functions Prototypes
  * @{
  */
...
/** @defgroup STM32H7S78_DK_SD_Exported_Functions SD Exported Functions
  * @{
  */
...
int32_t BSP_SD_DetectITConfig(uint32_t Instance)
{
  int32_t ret;
  GPIO_InitTypeDef gpio_init_structure = {0};
  static BSP_EXTI_SD_LineCallback SdCallback[SD_INSTANCES_NBR] = {SD_EXTI_Callback};
...
int32_t BSP_SD_GetCardInfo(uint32_t Instance, BSP_SD_CardInfo *CardInfo)
{
  ...
  {
    (void)HAL_SD_GetCardInfo(&hsd_sdmmc[Instance], CardInfo);
    ret = BSP_ERROR_NONE;
  }
...
/** @defgroup STM32H7S78_DK_SD_Private_Functions SD Private Functions
  * @{
  */
#if (USE_HAL_SD_REGISTER_CALLBACKS > 0)
/**
...
static void SD_MspInit(SD_HandleTypeDef *hsd)
{
  ...
  if (hsd == &hsd_sdmmc[0])
  {
    ...
    PeriphClkInitStruct.PeriphClockSelection = RCC_PERIPHCLK_SDMMC12;
    PeriphClkInitStruct.Sdmmc12ClockSelection = RCC_SDMMC12CLKSOURCE_PLL2S;
    ...
    /* GPIOC configuration D2*/
    gpioinitstruct.Alternate = GPIO_AF12_SDMMC1;
    gpioinitstruct.Pin = GPIO_PIN_10;
    HAL_GPIO_Init(GPIOC, &gpioinitstruct);

    /* GPIOC configuration, D0, D1, D3, CK*/
    gpioinitstruct.Alternate = GPIO_AF11_SDMMC1;
    gpioinitstruct.Pin = GPIO_PIN_8 | GPIO_PIN_9 | GPIO_PIN_11 | GPIO_PIN_12;
    HAL_GPIO_Init(GPIOC, &gpioinitstruct);
