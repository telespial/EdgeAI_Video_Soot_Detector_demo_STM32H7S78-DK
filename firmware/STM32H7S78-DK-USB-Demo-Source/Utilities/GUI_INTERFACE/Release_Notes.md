...
<center>
# Release Notes for 
# <mark>STM32 USB-C Power Delivery Graphical User Interface</mark>
...
The application can be found on ST website:
...
<label for="collapse-section28" aria-hidden="true">V3.0.1 / 8-Jan-2024</label>
<div>
...
**Fixed bugs list**
  ...
  Headline
  --------
  Adapt size of PDO list for EPR
  Refactoring CMSIS-RTOS API V1 related code
...
## Supported Devices and boards
  ...
  All STM32xx devices implementing a USBPD application able to communicate with STM32CubeMonUCPD

## Backward compatibility

  This version breaks the compatibility with previous ones

## Dependencies

  Compatible with FreeRTOS release 10.4.6 and above. CMSIS-RTOS API Version 1 no longer supported from GUI v3.0.0 version.
</div>
:::

::: {.collapse}
<input type="checkbox" id="collapse-section27" aria-hidden="true">
<label for="collapse-section27" aria-hidden="true">V3.0.0 / 19-Jun-2023</label>
<div>
...
**Fixed bugs list**
  ...
  Headline
  --------
  Update for H7RS series
  Remove "save in flash" feature for flashless products
  Remove support for CMSIS-RTOS API Version 1 no longer supported by FreeRTOS release 10.4.6
...
<label for="collapse-section26" aria-hidden="true">V2.3.0 / 9-May-2023</label>
<div>
...
**Fixed bugs list**
  ...
  Headline
  --------
  Update for CMSIS 5.9.0
  Fix GUI flash saving by correcting memorymap to support quad_word alignment
...
<label for="collapse-section25" aria-hidden="true">V2.2.3 / 21-Oct-2022</label>
<div>
...
<label for="collapse-section24" aria-hidden="true">V2.2.2 / 23-March-2022</label>
<div>
...
<label for="collapse-section23" aria-hidden="true">V2.2.1 / 23-December-2021</label>
<div>
...
<label for="collapse-section22" aria-hidden="true">V2.2.0 / 13-December-2021</label>
<div>
...
<label for="collapse-section21" aria-hidden="true">V2.1.0 / 20-September-2021</label>
<div>
...
<label for="collapse-section20" aria-hidden="true">V2.0.0 / 3-May-2021</label>
<div>
...
<label for="collapse-section19" aria-hidden="true">V1.14.0 / 19-Feb-2021</label>
<div>
...
<label for="collapse-section18" aria-hidden="true">V1.13.0 / 26-Oct.-2020</label>
<div>
...
<label for="collapse-section17" aria-hidden="true">V1.12.0 / 16-Oct.-2020</label>
<div>
...
<label for="collapse-section16" aria-hidden="true">V1.11.0 / 12-June-2020</label>
<div>
...
<label for="collapse-section15" aria-hidden="true">V1.10.2 / 13-May-2020</label>
<div>
...
<label for="collapse-section14" aria-hidden="true">V1.10.1 / 14-Apr.-2020</label>
<div>
...
<label for="collapse-section13" aria-hidden="true">V1.10.0 / 07-Apr.-2020</label>
<div>
...
<label for="collapse-section1" aria-hidden="true">V1.0.0 / 19-Jun-2018</label>
<div>			
