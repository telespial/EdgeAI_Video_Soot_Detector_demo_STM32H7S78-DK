...
//extern USBD_StatusTypeDef USBD_Init(USBD_HandleTypeDef *pdev, USBD_DescriptorsTypeDef *pdesc, uint8_t id);

//extern USBD_HandleTypeDef hUsbDeviceFS;
//extern USBH_HandleTypeDef hUsbHostFS;

uint8_t bDeviceStarted = 0U;
__IO uint8_t bHostStarted = 0U;
//uint8_t bDeviceStarted = 0U;
